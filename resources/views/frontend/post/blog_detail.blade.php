                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="blog-left">
                            ...
                            @if(count($post['cities']))
                            <div class="img-box-item">
                                <img src="{{asset('assets/images/pelican.png')}}" alt="">
                                <h3>Queerify berichtet vor Ort</h3>
                                <p>Queerify ist die neue Anlaufstelle für queere Orte. <br>
                                    In diesem Artikel haben wir von einer Stadt berichtet, für die wir Cafés, Bars und Clubs
                                    für LGBTIQ*s listen.
                                </p>
                                @foreach($post['cities'] as $city)
                                    <div class="col-md-12">
                                        <div class="cities__item hover__box">
                                            <div class="cities__thumb__blog hover__box__thumb">
                                                <a href="{{route('city_detail', $city->slug)}}" title="{{$city->name}}">
                                                    <img src="{{getImageUrl($city->banner)}}" alt="newyork">
                                                </a>
                                            </div>
                            ...
                            <div class="related-post">
                                ...
                                <div class="related-grid columns-3">
                                    @foreach($related_posts as $related_post)
                                        <article class="hover__box post pt-3">
