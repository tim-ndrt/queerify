        ...
        <main id="main" class="site-main">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="cs-info">
                            <h1>Bald für <br> <span>dich</span> da!</h1>
                            <p>Queerify ist ein <span>Ort</span> um queere <span>Orte</span> zu entdecken.</p>
                            <p><b>Schreib uns </b><a href="#">hello@queerify.de</a></p>
                        </div><!-- .cs-info -->
                    </div>
                    <div class="col-md-6">
                        <div class="cs-thumb">
