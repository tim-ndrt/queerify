                            ...
                            <div class="popup popup--left">
                                ...
                                <div class="popup__content">
                                    ...
                                    <div class="popup__menu popup__box">
                                        <ul class="menu-arrow">
                                            <li><a title="Home demo" href="{{route('home')}}">Home</a></li>
                                            <li>
                                                <a title="Place detail" href="#">Place detail</a>
                                                <ul class="sub-menu">
                                                    <li><a href="https://lara.getgolo.com/place/boot-cafe">Booking form</a></li>
                                                    <li><a href="https://lara.getgolo.com/place/le-meurice">Affiliate Book Buttons</a></li>
                                                    <li><a href="https://lara.getgolo.com/place/musee-guimet">Affiliate Banner Ads</a></li>
                                                    <li><a href="https://lara.getgolo.com/place/clamato">Enquiry Form</a></li>
                                                </ul>
                                            </li>
                                            <li>
